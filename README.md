<div align="center">
	<img alt="Sulaman's Welcome Message" src="https://readme-typing-svg.herokuapp.com/?lines=AI+Engineer+%7C+LLM+%7C+RAG+%7C+Agents;8+Years+Production+Software+Engineering;Building+Production-Grade+AI+Systems&center=true&width=600&height=55">
</div>
...
That discipline comes from years building **fintech platforms** (processing $1M+ in transactions), **high-traffic systems** (100,000+ daily users), and **Layer 1 blockchain infrastructure**. I already know how to ship secure, scalable systems — I apply that same rigor to the AI layer.

> **The AI is learnable in months; the engineering judgment took 8 years. I bring both.**

🌍 Open to **remote AI Engineer / LLM Engineer** roles (US & Gulf time zones).
...
Production RAG API built with **Python, FastAPI, ChromaDB, and Ollama**. Features token streaming via Server-Sent Events (SSE), tenant-isolated retrieval enforced per request (verified zero cross-tenant leakage), cost/latency observability middleware, and provider-failure handling. Demonstrates RAG delivered as a secure, scalable service.

#### 🔌 MCP Server & Client
Both halves of a **Model Context Protocol** integration — a server exposing tools and resources, and a client that discovers and calls them at runtime, wired into a local-model agent loop. Shows the modern standard for connecting AI to internal systems.

#### 🧠 Agentic System (ReAct)
An LLM agent with a **think → act → observe** tool-calling loop, step-limit safety caps, and schema validation at the tool boundary. Implemented in raw orchestration **and** rebuilt in **LangGraph** to demonstrate both fundamentals and framework fluency.

#### 🎫 Support Ticket Triage Engine
LLM system that classifies priority, extracts structured fields, and drafts replies from raw tickets — featuring graceful degradation and clean engine/interface separation for production use.

#### 🛒 Retail Shelf Detection & Recognition
Computer-vision pipeline integrating **YOLO** for shelf/product detection, **OCR** for on-shelf text extraction, and **ArcFace** for face recognition — combining multiple deep-learning models into one working system.

#### 🧾 ZATCA Phase 2 E-Invoicing
Saudi Arabia e-invoicing compliance implementation (Fatoora, XML generation, certificate signing) — direct experience with Kingdom of Saudi Arabia (KSA) regulatory requirements.

---

## 🎯 Engineering Highlights

- **AI Systems:** Built RAG pipelines, agents, and MCP integrations with production concerns — evaluation harnesses (retrieval hit-rate + faithfulness), multi-provider abstraction (Anthropic Claude, OpenAI), and defensive structured-output parsing.
- **Optimized API Performance:** Refined a blockchain art API to handle **1M+ requests** efficiently with careful server-resource management.
- **Performance at Scale:** Migrated a high-traffic **Node.js** service serving **1M users to Go**, resolving memory issues for seamless performance.
...
| **Blockchain** | ![Substrate](https://img.shields.io/badge/Substrate-282828?style=for-the-badge&logo=substrate&logoColor=white) ![GraphQL](https://img.shields.io/badge/-GraphQL-E10098?style=for-the-badge&logo=graphql&logoColor=white) |

---

## 🔗 Selected Prior Work (Blockchain & Product)

Deep backend and blockchain experience that underpins my production engineering discipline:

- [**⛓️ Elysium Chain**](https://elysiumchain.tech/) — Layer 1 blockchain (Substrate + EVM) for AI, gaming, and metaverse projects.
